...
class CategoriesAdapter (val context: Context, val phone : List<categoriesItem>) :
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        holder.itemView.phoneFavourate.setOnClickListener {
            if(FirebaseAuth.getInstance().currentUser==null){
                ...
                val user = UserEntity(0,FirebaseAuth.getInstance().uid.toString(),phone[position].name,
